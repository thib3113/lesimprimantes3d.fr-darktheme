...
const main = async (): Promise<void> => {
    ...
    const authenticatePage = (await axiosInstance.get('/d/login', {
        params: {
            view:'password'
        }
    })).data
    ...
    data = {};
    $('#password-login').serializeArray().forEach((field) => {
    ...
    const styleEditPage = (await axiosInstance.get(`/d/styles/${styleId}/edit`, {
        jar,
        withCredentials: true
    })).data
